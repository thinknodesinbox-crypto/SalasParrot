...
export const Route = createLazyFileRoute('/dashboard/accounts')({
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-sm text-[#64748B]">
              {subscriptionLabels[account.subscription_type] || 'LinkedIn Classic'}
            </p>
          </div>
        </div>
...
function ConnectEmailModal({ onClose }: { onClose: () => void }) {
  ...
  const handleMicrosoftOAuth = async () => {
    ...
    try {
      ...
      const result = isHostedAuth
        ? await initOutlookHostedAuth.mutateAsync({
            returnUrl,
            syncMode,
            workspaceId: currentWorkspaceId || undefined,
          })
        : await initMicrosoftOAuth.mutateAsync({
            returnUrl,
            syncMode,
            workspaceId: currentWorkspaceId || undefined,
          });
