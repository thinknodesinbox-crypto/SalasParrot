import { useSearch, useNavigate, createLazyFileRoute } from '@tanstack/react-router';
...
const ImportLeadsModal = lazy(async () => {
  const module = await import('./leads.lazy');
  return { default: module.ImportLeadsModal };
});

export const Route = createLazyFileRoute('/dashboard/campaigns')({
